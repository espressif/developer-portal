...
> Note: Windows: Please enter the COM Port number available from the device manager in [step 1.3](#13-installing-the-driver). For this example, the COM port used is COM11, but the COM Port number might be different across devices.
