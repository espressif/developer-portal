...
For testing purposes, we tried the [ESP32-C3-Lyra V2.0](https://docs.espressif.com/projects/esp-adf/en/latest/design-guide/dev-boards/user-guide-esp32-c3-lyra.html) due to the easy integration with LED strips.

This board integrates 2 interfaces for LED strips (addressable and regular RGB) with a 12V DC power port connector. The DC power connector facilitates the use of 12V LED strips and you can use just one power supply to power the LEDs and the ESP32-C3.

The LED interface used for the test was the **Addressable LED Strip Port**. Currently, the **RGB LED Strip Port** is not supported by the WLED project.
...
This board also integrates a microphone for sound reactivity and an IR receiver for remote control; however, these features were not tested.
...
As mentioned before, the support for the ESP32-C3 is still experimental and you can use for testing purpose.
